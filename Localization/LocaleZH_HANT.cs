...
namespace FastBikes
{
    ...
    public sealed class LocaleZH_HANT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionGroupLocaleID(Setting.AboutDebugGrp), "偵錯" },
    ...
    //            },
                ...
                // Path Speed
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.PathSpeedScalar)), "路徑速度限制" },
                ...
                // Status lines
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.StatusSummary1)), "自行車群組" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.StatusSummary2)), "汽車群組" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.StatusSummary3)), "隱藏停放汽車" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.LogBorderHiddenCars)), "記錄隱藏汽車" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OpenLogFromStatus)), "開啟日誌" },
                ...
                // Debug
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DumpBicyclePrefabs)), "自行車偵錯報告" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OpenLogFromDebug)), "開啟日誌" },
