...
namespace FastBikes
{
    ...
    public sealed class LocaleFR : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { m_Setting.GetOptionGroupLocaleID(Setting.ActionsStatusGrp),     "État des véhicules personnels" },
    ...
    //            },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.StatusSummary3)), "Voitures stationnées cachées" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.LogBorderHiddenCars)), "Journaliser les voitures cachées" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OpenLogFromStatus)), "Ouvrir le journal" },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.OpenLogFromDebug)), "Ouvrir le journal" },
